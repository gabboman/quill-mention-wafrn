var quillMention = (function (t) {
  ...
  function E(t, e) {
    null !== e && ("object" === s(e) ? t.appendChild(e) : (t.innerText = e));
  }
  var O = (function (t) {
    !(function (t, e) {
        ...
        [
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              return (n.value = u({}, this.domNode.dataset)), (n.event = e), n;
            },
          },
        ],
        [
  ...
  var L = (function () {
    function t(e, n) {
      ...
      try {
        for (a.s(); !(s = a.n()).done; ) {
          var l = s.value;
          e.keyboard.addBinding({ key: l }, this.selectHandler.bind(this));
        }
      } catch (t) {
        a.e(t);
      } finally {
      ...
      e.keyboard.bindings[C].unshift(e.keyboard.bindings[C].pop()),
        e.keyboard.addBinding({ key: x }, this.escapeHandler.bind(this)),
      ...
      l(t, [
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if (null !== s) {
              ...
              return (
                a.spaceAfterInsert
                  ? (this.quill.insertText(r + 1, " ", n.default.sources.USER),
                    this.quill.setSelection(r + 2, n.default.sources.USER))
                  : this.quill.setSelection(r + 1, n.default.sources.USER),
                this.hideMentionList(),
                l
              );
            }
            ...
            if (this.options.renderLoading())
              if (
                ...
                (t.className = "ql-mention-loading"),
                  E(t, this.options.renderLoading()),
              ...
              for (var i = -1, o = 0; o < e.length; o += 1) {
                ...
                (s.id = "quill-mention-item-" + o),
                  ...
                  e[o].disabled
                    ...
                    : -1 === i && (i = o),
                  (s.dataset.index = o),
                  E(s, this.options.renderItem(e[o], n)),
                  e[o].disabled
                    ? (s.onmouseenter =
                  ...
                  this.mentionList.appendChild(
                    w(s, e[o], this.options.dataAttributes),
                  );
              }
              (this.itemIndex = i),
                this.highlightItem(),
        ...
        },
        {
          ...
          value: function () {
            ...
            if (this.options.fixMentionsToQuill) {
              var a = o.right;
              this.mentionContainer.style.right = "".concat(a, "px");
            } else
            ...
            ("top" === this.options.defaultMenuOrientation && c
              ? "top"
              : ("bottom" === this.options.defaultMenuOrientation && u) || h > l
                ? "bottom"
                : "top")
              ? ((s = o.top + o.height),
                u || (this.mentionContainer.style.height = h - 3 + "px"),
                this.options.mentionContainerClass
                  .split(" ")
                  .forEach(function (e) {
                    t.mentionContainer.classList.add("".concat(e, "-bottom")),
              ...
              (this.mentionContainer.style.left = "".concat(r, "px")),
              (this.mentionContainer.style.visibility = "visible");
          },
        },
        {
          ...
          value: function () {
            ...
            if (null != e) {
              ...
              var n,
                ...
                a = Math.max(0, this.cursorPos - this.options.maxChars),
                  ...
                  i.reduce(
                    function (t, e) {
                      ...
                      if (o && s) {
                        ...
                        i =
                          a !== e ? n.lastIndexOf(a) + a.length - e.length : 0;
